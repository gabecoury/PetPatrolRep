...
public class AddReportFragment extends Fragment{
    ...
    private DatePicker mEventStartDatePicker;
    private DatePicker mEventEndDatePicker;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mEventSubmitButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                mEvent.setEventStartDateTime(mEventStartDate);
                ...
                Toast.makeText(getContext(), "Event Created: " + mEvent.getEventName() + " will start on " + mEvent.getEventStartDateTime().toString() + ". Please call " + mEvent.getContactNumber() + " details: " + mEvent.getDetails(),Toast.LENGTH_LONG).show();
